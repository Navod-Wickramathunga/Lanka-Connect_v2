...
import 'service_image_defaults.dart';
...
class DemoDataService {
  ...
  _demoServices({
    ...
    Map<String, dynamic> buildService({
      ...
      return {
        ...
        'status': status,
        'imageUrls': defaultServiceImageUrls(category: category, title: title),
        ...timestamp,
      };
    }
    ...
    return [
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 80.6337,
          description:
              'Float valve checks, minor repairs, and water flow tuning.',
          status: 'approved',
        ),
      ),
      (
        ...
        payload: buildService(
          ...
          lng: 80.0640,
          description:
              'Tap, shower, and flush leak repairs with replacement parts.',
          status: 'approved',
        ),
      ),
      (
        ...
        payload: buildService(
          ...
          lng: 80.5550,
          description:
              'Rapid response for burst lines and urgent pipe changes.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 80.1017,
          description:
              'Garden and gate lighting layout with weather-safe fixtures.',
          status: 'approved',
        ),
      ),
      (
        ...
        payload: buildService(
          ...
          lng: 80.3647,
          description:
              'Generator wiring checks and safe emergency backup setup.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 79.9220,
          description:
              'Cabinet alignment, handle fitting, and shelf installation.',
          status: 'approved',
        ),
      ),
      (
        ...
        payload: buildService(
          ...
          lng: 79.9607,
          description:
              'Door alignment, hinge replacement, and sliding door fixes.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 79.8358,
          description:
              'Professional interior painting with premium emulsion paint.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 79.8624,
          description:
              'Balcony planter cleanup and maintenance for city homes.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 80.2147,
          description:
              'Plant bed redesign and color-balanced seasonal planting.',
          status: 'approved',
        ),
      ),
      (
        ...
        payload: buildService(
          ...
          lng: 79.8883,
          description:
              'Packing, loading, transport coordination, and unloading.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 80.6159,
          description:
              'Quick transport for studio apartments and urgent moves.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 79.8358,
          description:
              'Event makeup with hairstyling support at your location.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 80.2210,
          description:
              'Hydrating facial care with cleanup and skin prep advice.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 79.9528,
          description:
              'Writing, grammar, and speaking support for school exams.',
          status: 'approved',
        ),
      ),
      (
        ...
        payload: buildService(
          ...
          lng: 80.6337,
          description:
              'Practical science guidance with revision-focused sessions.',
          status: 'approved',
        ),
      ),
      (
      ...
      (
        ...
        payload: buildService(
          ...
          lng: 80.4298,
          description:
              'Computer basics, Office apps, and beginner internet skills.',
          status: 'approved',
        ),
      ),
    ];
  ...
  static Future<void> _seedService({
    ...
    final desiredImages = ((payload['imageUrls'] as List?) ?? const [])
        .map((e) => e.toString())
    ...
    final existingImages = ((snap.data()?['imageUrls'] as List?) ?? const [])
        .map((e) => e.toString())
        .where((e) => e.isNotEmpty)
        .toList();
    ...
    if (existingImages.isEmpty && desiredImages.isNotEmpty) {
      updates['imageUrls'] = desiredImages;
    }
